...
const NFT_COLLECTION = {
  name: "Cyber Phantoms",
  description: "10,000 unique generative Phantoms on Solana. Each one grants DAO voting rights.",
  supply: 10000,
  minted: 6843,
  price: "0.1 SOL",
  priceUsd: "$17.50",
...
export default function PixelDrop() {
  ...
  const scenarioLabel = dangerous
    ...
    : `Mint ${qty} Cyber Phantom NFT(s) for ${(qty * 0.1).toFixed(2)} SOL`;
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.15 }} className="space-y-6">
              ...
              <div className="glass rounded-2xl p-5 space-y-4">
                ...
                <div className="border-t border-white/5 pt-4 flex justify-between">
                  ...
                  <span className="font-bold text-white">{(0.1 * qty).toFixed(2)} SOL <span className="text-white/30 text-xs font-normal">${(17.5 * qty).toFixed(2)}</span></span>
                </div>
              </div>
